...
public class UserGeneralPresentation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // toolbargeneral = findViewById(R.id.general_toolbar);
        ...
        titre_produit = getIntent().getExtras().getString("titre_produit");
        prix_produit = getIntent().getExtras().getString("prix_produit");
        ...
        firebaseFirestore.collection("publication").document("post utilisateur").collection(current_user_id).addSnapshotListener(UserGeneralPresentation.this,new EventListener<QuerySnapshot>() {
            @Override
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    if (task.getResult ().exists ()){
                        ...
                        call=task.getResult().getString("user_telephone");
                        ...
                        user_name.setAnimation(AnimationUtils.loadAnimation(getApplicationContext(),R.anim.fade_scale_animation));
                        residence.setAnimation(AnimationUtils.loadAnimation(getApplicationContext(),R.anim.fade_scale_animation));
                        general_last_seen.setAnimation(AnimationUtils.loadAnimation(getApplicationContext(),R.anim.fade_scale_animation));
                        total_vente.setAnimation(AnimationUtils.loadAnimation(getApplicationContext(),R.anim.fade_scale_animation));
