...
public class Telephone_tab_adapter  extends FragmentPagerAdapter {
        ...
        public Telephone_tab_adapter(FragmentManager fm) {
            super(fm);
        }
        @Nullable
        @Override
        ...
        public Fragment getItem(int i) {
            ...
            switch (i){
                case 0:
                    TelephoneFragment home =new TelephoneFragment();
                    return home;
            }
