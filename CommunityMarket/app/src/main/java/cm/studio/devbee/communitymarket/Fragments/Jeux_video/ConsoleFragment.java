...
public class ConsoleFragment extends Fragment {
    ...
    public void RecyclerView(){
        ...
        Query firstQuery =firebaseFirestore.collection ( "publication" ).document ("categories").collection ( "Jeux et console" ).document("dans").collection ( "console").orderBy ( "priority",Query.Direction.DESCENDING );
        ...
        acessoireRecyclerView = v.findViewById(R.id.consoleRecyclerView);
