package cm.studio.devbee.communitymarket.Fragments.Telephone_tablette;
...
public class TelephoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         v = inflater.inflate(R.layout.fragment_telephone, container, false);
    ...
    public void pullRecyclerView(){
        Query firstQuery =firebaseFirestore.collection ( "publication" ).document ("categories").collection ( "Phone et Tablette" ).document("dans").collection ( "Telephones").orderBy ( "priority",Query.Direction.DESCENDING );
        ...
        pullRecyclerView = v.findViewById(R.id.telephoneRecyclerView);
        ...
        user_two.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot> () {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    //image_one
                    firebaseFirestore.collection("Slider_telephone").document("image_One").get().addOnCompleteListener(getActivity (),new OnCompleteListener<DocumentSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()){
                    ...
                    //image_two
                    firebaseFirestore.collection("Slider_telephone").document("imageTwo").get().addOnCompleteListener(getActivity (),new OnCompleteListener<DocumentSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()){
                                if (task.getResult().exists()){
                    ...
                    //image_three
                    firebaseFirestore.collection("Slider_telephone").document("imageThree").get().addOnCompleteListener(getActivity (),new OnCompleteListener<DocumentSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()){
                                if (task.getResult().exists()){
                    ...
                    //image_four
                    firebaseFirestore.collection("Slider_telephone").document("imageFour").get().addOnCompleteListener(getActivity (),new OnCompleteListener<DocumentSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()){
                                if (task.getResult().exists()){
