 ...
 */
public class Accssoire_Jeux_Fragment extends Fragment {
    ...
    public Accssoire_Jeux_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate ( R.layout.fragment_accssoire__jeux_, container, false );
    ...
    public void RecyclerView(){
        ...
        Query firstQuery =firebaseFirestore.collection ( "publication" ).document ("categories").collection ( "Jeux et console" ).document("dans").collection ( "Accessoires").orderBy ( "priority",Query.Direction.DESCENDING );
        ...
        acessoireRecyclerView = v.findViewById(R.id.assesoire_jeux_RecyclerView);
